...
// Función para obtener los campos que se pueden actualizar por tabla
  const getFieldsToUpdate = (tableName: string): string[] => {
    const fieldMappings: Record<string, string[]> = {
      ...
      'localizacionsensor': ['localizacionid', 'sensorid', 'metricaid', 'localizacionsensor', 'statusid'],
...
setIndividualRowStatus(newIndividualStatus);
                                ...
                                className="px-3 py-1 bg-blue-600 text-white rounded text-sm hover:bg-blue-700 transition-colors font-mono tracking-wider"
...
{/* Modal de confirmación para cancelar */}
      ...
      {showCancelModal && (
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          ...
          <div className="bg-white dark:bg-neutral-800 border border-blue-500 rounded-lg p-6 max-w-md mx-4">
